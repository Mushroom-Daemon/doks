...
---
TO MAKE THIS USEFUL, ADD A TO-DO TO EVERY CHECKLIST.... AS IN, FIND ANY PARAGRPAHS USING MORE THAN THREE SENTENCES. CAN YOU BREAK IT INTO TWO?
...
The following checklist will help to make your copy more *engaging*. This begins with formating and

scannable, simple sentences, conversationsil.

You copy is only effective if it's read. Period. As such, every element of your ad should serve one single purpose...
...
Before your prospect reads a single line of your copy, they have to be invited into the page.

A throat-grabbing headline will do it. But equally important is how you format your content.

Look at this pic. Which would you rather read?

#### Use Short Paragraphs

In modern, digital writing, I find a maximum of three sentences per paragraph works well.

If you're tempted to write four sentences, find a way to break the paragraph into two. You'll notice all copy on this site follows this basic rule.

(Side note: Sometimes novelists carry this idea into writing short chapters. It makes it easier to keep moving through long texts.)
...
* Include SEO keywords LINK in headings
* Use user-asked questions as subheadings for AEO LINK
* Write subheadings which as complee nonsense like "scrammbled eggs"

Whichever subheading approach you take will depend on your goals. Just know that nonsense is legit... it still breaks up the content and makes it more inviting.

#### Use Bullet Lists

When appropriate, use bullet lists.

* They're easy to skim
* They break up text
* And that's good

### 2. Edit for Simplicity

* Nothing fancy. Hammer out the main bits. Do it clearly.

The goal of all kickass copy is to be clear, simple, and to the point. Why?

Because readers go with the offers they most quickly understand.
...
* Ask if a child can understand your offer
...
### 3. Short First Sentences

Reading requires a bit of inertia. Short first sentences suck the reader in and get their eye moving across the page.
...
For a list of short sentences to get the juices flowing go HERE.

### 4. Keep it Snappy

An interesting rhythm keeps your reader moving through the text. Experiment with the following to give your copy a lively beat.

* One sentence, one point
* Fragments = okay
* Hyphenate sentences&mdash;makes 'em shorter
* Begin sentences with "And," "But," "Because," "Or," "So"
* CTRL+F for "that"... which can often be removed/reworked
* Alternate short and longer sentences
* Use transition words (for example, typically, as such, etc.)

Your over-arching goal is brevity&mdash;sharing the greatest amount of emotion with the fewest words possible.

### 5. The Slippery Slide

Tattoo it to the inside of your skull.

*Your reader must read the copy!*

...

*All the way to the end!*

To suck them through like a Hoover vacuum, try the following:

* Anticipate and answer questions as you go
* Rearrange flow of ideas if an area feels stagnant
* Tease upcoming content (in the next section, more on that later, etc.)
* Start your presentation with a fat slab of curiousity
* End paragraphs with "cliffhangers" ADD LUBRICATION
  * Then something strange happened
  * You think that's weird? Check this out.
  * What's so great about the Copy Playbook? Let me explain.

* Then something simple—but brilliant—happened. (Dan Lapp)
...
### Example: Integro Newsletter Blip
