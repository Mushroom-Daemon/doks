...
---
Brand Guidelines Deliverable MVP
1. Customer Persona


2. Brand Personality/Product Principles with Brief Description
Ex: Partnership: Tristate Buildings partners with our clients, coming alongside them and their dreams. Our approach is warm, friendly, and human—like a friend who’s been putting up post-frame structures of every type for over 35 years.
3. Concepts/Dos and Don’ts
Dos and Don’ts (concepts to portray principles)
Do say/don’t say example sentence for each principle (optional)
4. Words and Phrases to Use/Don’t Use
5. Verbosity (Optional)
Sentence length, emojis, fragments, etc.
6. Style Guide on Grammar/Punctuation/Capitalization (Optional)
7. Approved/Rejected Copy (Optional)
